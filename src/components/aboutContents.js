    ...
    <div className="pb-30 sm:pb-40 md:pb-50 lg:pb-60 2xl:pb-70">
      ...
      <ContainerSec>
        <div className="bg-[#000000] mx-auto mt-20 sm:mt-24 md:mt-30 lg:mt-36 2xl:mt-40">
          <div className="flex flex-col sm:flex-row items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-5 md:mb-6 lg:mb-8 px-4 sm:px-0">
          ...
          <div className="hidden lg:block w-full overflow-hidden rounded-lg select-none px-2 sm:px-0">
            <iframe
          ...
          <div className="lg:hidden xl:hidden 2xl:hidden w-full bg-transparent rounded-lg p-6 sm:p-8 border border-gray-300 shadow-lg shadow-gray-300/20 text-center">
        ...
        <div className="2xl:mt-25 xl:mt-25 lg:mt-25 md:mt-0 mt-15">
          <h1 className="text-[24px] sm:text-[28px] md:text-[32px] lg:text-[36px] 2xl:text-[40px] text-white font-Bebas">
            ​Academic Affiliations
          </h1>
          <p className="text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] 2xl:text-[17px] text-white font-Supreme mt-2 sm:mt-3 md:mt-4">
          ...
          <div className="mt-4 sm:mt-5 md:mt-6 lg:mt-8 2xl:mt-10 grid 2xl:grid-cols-5 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-2 sm:gap-3 md:gap-4 lg:gap-6 2xl:gap-8">
